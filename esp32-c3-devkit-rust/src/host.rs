...
impl<B> HostContext<Esp32Host<B>> for Esp32HostContext
where
    B: FrameBufferBackend<Color = Rgb565>,
{
    fn frame_buffer_context(&self) -> <<Esp32Host<B> as Host>::FrameBuffer as FrameBuffer>::Context {
        ()
    }
}
